...
# __HARDEN_VERSION_FILES_START__
# Default: detect the first version file found
# The SKILL.md replaces this section with explicit paths.
VERSION_SOURCE=""
for candidate in \
...
if [[ -z "$VERSION_SOURCE" ]]; then
  print_error "No version file found"
  exit 1
fi
# __HARDEN_VERSION_FILES_END__
...
# __HARDEN_UPDATE_START__
# Default: update the detected source file only
update_version "$VERSION_SOURCE" "$NEW_VERSION"
# __HARDEN_UPDATE_END__
